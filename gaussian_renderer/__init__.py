...
# xxadd 0925 params: kernel_size, subpixel_offset
def render(viewpoint_camera, pc : Union[GaussianModel, FlameGaussianModel], pipe, bg_color : torch.Tensor, kernel_size: float, scaling_modifier = 1.0, override_color = None, subpixel_offset=None):
    """
    Render the scene. 
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        tanfovx=tanfovx,
        tanfovy=tanfovy,
        kernel_size=kernel_size,  # xxadd 0925
        subpixel_offset=subpixel_offset, # xxadd 0925
        bg=bg_color,
    ...
    # if pipe.compute_view2gaussian_python: # False 在python算公式12上方的gaussian normal
    ...
    rendered_image, radii = rasterizer(
        ...
        view2gaussian_precomp=view2gaussian_precomp) # xxadd 0925
...
def integrate(points3D, viewpoint_camera, pc : Union[GaussianModel, FlameGaussianModel], pipe, bg_color: torch.Tensor, kernel_size: float,
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        bg=bg_color,
        scale_modifier=scaling_modifier,
        viewmatrix=viewpoint_camera.world_view_transform.cuda(), # xx0926 这仨之前不在cuda
        projmatrix=viewpoint_camera.full_proj_transform.cuda(), #
        sh_degree=pc.active_sh_degree,
        campos=viewpoint_camera.camera_center.cuda(), #
        prefiltered=False,
