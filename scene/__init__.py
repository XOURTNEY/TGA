...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : Union[GaussianModel, FlameGaussianModel], load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            print("Found FLAME parameter, assuming dynamic NeRF data set!") # flame
        ...
        for resolution_scale in resolution_scales:
            print("Loading Training Cameras") # 读入相机参数
        ...
        # process meshes 导入flame的核心操作
        if gaussians.binding != None: # not None
    ...
    def save(self, iteration):
        ...
        self.gaussians.save_ply_with_color(os.path.join(point_cloud_path, "pcd_color.ply"))
